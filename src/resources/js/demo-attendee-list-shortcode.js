...
jQuery( document ).ready( function ( $ ) {
	const {
		rest_endpoint, nonce, error_message, no_attendee_message, attendee_labels
	...
	$.ajax( {
		url: attendeesEndpoint, type: 'GET', dataType: 'json', headers: {
			'X-WP-Nonce': nonce,
		}, success: renderAttendees, error: function ( xhr, status, error ) {
